...
{block name='page_header_container'}
	...
	{/block}
{/block}
                            </div></div><div class="row no-margin gr_column"><div class="pb-left-column pb_column col-xl-6 col-lg-6 col-md-7-2 col-sm-12 col-xs-12 col-sp-12">
...
<div class="product-actions">
  ...
  {/block}
                            ...
                            </div></div><div class="row"><div class="col-form_id-form_5994794356949567 col-md-12 col-lg-12 col-xl-12 col-sm-12 col-xs-12 col-sp-12">
