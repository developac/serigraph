...
{else}
						...
						<div class="manufacturer-container manufacturer-block" itemscope itemtype="https://schema.org/Brand">
		    				<div class="left-block">
		    					<div class="manufacturer-image-container image">
		    						<a title="{l s='%s' sprintf=[$manu.name] d='Shop.Theme.Global'}" href="{$link->getmanufacturerLink($manu.id_manufacturer, $manu.link_rewrite)|escape:'html':'UTF-8'}" itemprop="url">
    ...
    {else}
        <p class="alert alert-info">{l s='No manufacturer at this time.' d='Shop.Theme.Global'}</p>
    {/if}
{/if}
