    ...
    <div class="block {(isset($formAtts.class)) ? $formAtts.class : ''|escape:'html':'UTF-8'} instagram-block">
        ...
        <div class="block_content">
            ...
            {if isset($formAtts.profile_link) && $formAtts.profile_link}
                <a href="https://instagram.com/{$formAtts.profile_link|escape:'html':'UTF-8'}" title="{l s='View all in instagram' d='Shop.Theme.Global'}"><i class="fa fa-instagram"></i>&nbsp;&nbsp;{l s='View all in instagram' d='Shop.Theme.Global'}</a>
            {/if}
            </p>
        </div>
        {/if}
